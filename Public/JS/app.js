...
var updateToCart = function updateToCart(pizza) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/upda');
};

addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    //#pre define method    variable to set in data method home.ejs page
    var pizz = btn.dataset.pizza; //> here we are doing get the data while click to button in JSON string formate
