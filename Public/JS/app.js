...
var initAdmin = function initAdmin() {
  ...
  axios.get('/admin/orders', {
    ...
    console.log(err);
  }); //this is display data inside the data
...
//console.log('my name is jitu')
 //^ this import from nude_modules folder

 //!this is for notification status 

 //here we  are import the admin.js files

var addToCart = document.querySelectorAll('.add-to-cart'); //>  addToCart in this variable data come in the form of array type
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    var pizza = JSON.parse(btn.dataset.pizza); //this JSON string data  convert into object

    updateToCart(pizza); //console.log(pizz);
...
(0,_admin__WEBPACK_IMPORTED_MODULE_2__.initAdmin)(); //here we are calling this function because we want all code from admin.js
